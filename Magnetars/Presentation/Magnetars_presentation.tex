...
\begin{itemize}
 ...
 \item<5-> period range of 2-12s %likely due to magnetic breaking
\end{itemize}
\end{block}
\begin{block}{Cases:}
...
\begin{itemize}
 \item<2-> Neutron stars with $\approx 1$ ms period at birth [1]%\pause
 \item<4-> 
\end{itemize}
\end{block}
...
\begin{itemize}
	\item<3-> ~100 ms rotational period%period high-band bursts (mostly X-ray)
